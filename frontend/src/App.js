...
import SellerVerificationPage from "./pages/seller/sellerVerificationPage/SellerVerificationPage";

// Buyer page
import BuyerProducts from "./pages/buyer/productListing/BuyerProducts";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/buyer/products" element={<BuyerProducts />}></Route>
      </Routes>
      <FooterComponent />
    </BrowserRouter>
  );
